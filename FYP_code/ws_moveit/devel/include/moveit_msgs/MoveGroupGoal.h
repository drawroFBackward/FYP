...
struct MD5Sum< ::moveit_msgs::MoveGroupGoal_<ContainerAllocator> >
{
  ...
  {
    return "0ee3372c12e27ab11dea1af77900fbb1";
  }

  static const char* value(const ::moveit_msgs::MoveGroupGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x0ee3372c12e27ab1ULL;
  static const uint64_t static_value2 = 0x1dea1af77900fbb1ULL;
};
