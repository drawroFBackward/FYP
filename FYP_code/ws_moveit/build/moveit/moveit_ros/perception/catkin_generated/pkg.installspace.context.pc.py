...
PROJECT_CATKIN_DEPENDS = "image_transport;moveit_core;moveit_msgs;moveit_ros_occupancy_map_monitor;object_recognition_msgs;roscpp;sensor_msgs;tf2_geometry_msgs".replace(';', ' ')
