...
public:
    ...
    void retranslateUi(QWidget *MotionPlanningUI)
    {
        ...
        database_host->setText(QApplication::translate("MotionPlanningUI", "127.0.0.1", nullptr));
...
"This is usually achieved by random seeding, which can flip the robot configuration (e.g. elbow up/down). Note that motion planning is always collision-aware, regardless of this checkbox.", nullptr));
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        shape_size_z_spin_box->setToolTip(QApplication::translate("MotionPlanningUI", "y dimension", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        shape_size_y_spin_box->setToolTip(QApplication::translate("MotionPlanningUI", "z dimension", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        export_scene_geometry_text_button->setToolTip(QApplication::translate("MotionPlanningUI", "Export scene geometry to a .scene file (only geometry information is preserved)", nullptr));
#endif // QT_NO_TOOLTIP
        export_scene_geometry_text_button->setText(QApplication::translate("MotionPlanningUI", "&Export", nullptr));
#ifndef QT_NO_TOOLTIP
        import_scene_geometry_text_button->setToolTip(QApplication::translate("MotionPlanningUI", "Import scene geometry from a .scene file (only geometry information is preserved)", nullptr));
#endif // QT_NO_TOOLTIP
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("MotionPlanningUI", "Status", nullptr));
